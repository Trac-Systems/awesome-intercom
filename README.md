...
- [TaskDropper](https://github.com/Davexinoh/TaskDropper) -Minimal peer-to-peer task board built on Intercom. Post tasks to a shared sidechannel, claim them, and mark them done. No server, no central authority. + Repo: https://github.com/Davexinoh/TaskDropper.+ Live demo: https://davexinoh.github.io/TaskDropper/
